...
# Scatter plot for PCA components (Question 2)

Xax = X_pca[:, 2]   # First principal component
Yax = X_pca[:, 0]   # Second principal component
#Zaz = X_pca[:, 2]   # Third principal component (maybeee)
labels = cancer.target


# Define dictionaries for colors, labels, and markers
cdict  = {0: 'red', 1: 'green'}
